...
carControllers.controller('rentedCarCtrl', ['$scope', '$location', 'API', 'Auth', 'Researches', '$routeParams', '$window', 'ToastOptions', 'Messages', 
	function($scope, $location, API, Auth, Researches, $routeParams ,$window, ToastOptions, Messages) {
		...
		$scope.getCars = function(){
			...
			$scope.url = 'car-master-get-rented-cars';
